...
// code for background
    for (var i = 0; i<12; i++) {
      ...
      saturation = Math.round(Math.random()*10);
...
function drawPaths() {// draw svgs for background
    var paths = [
    ...
    var cont = document.getElementById('imggg');
    ...
    //cont.setBackground(svg);
    //const element = document.getElementById("back").children[0];
    //const newNode = document.

    //document.getElementById().replaceChild(svg, element.childNodes[0]);

    //document.getElementById("imggg").style.backgroundColor="red";
